...
<title>CultSoft Bank</title>
    <link href="images/CultSoft_symbol.jpg" rel="icon">
   <link href="images/CultSoft_symbol.jpg" rel="apple-touch-icon"> 
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.0/js/bootstrap.min.js"></script>
  ...
  <?php 
 $con = new mysqli('localhost','root','','CultSoft_bank');
...
<nav class="navbar navbar-expand-xl navbar-light bg-light">
	<a href="home.php" class="navbar-brand"><img src="images/CultSoft_symbol.jpg" width="45" alt="" class="logo-img"><b>CultSoft Bank</b></a>
      ...
      <section class="light">
		...
		<article class="postcard light blue">
			<a class="postcard__img_link" href="#">
				<img class="postcard__img" src="images/CultSoft_symbol.jpg" alt="Image Title" />
			</a>
			<div class="postcard__text t-dark">
				<h1 class="postcard__title blue"><a href="#">Welcome to CultSoft Bank</a></h1>
				
				<div class="postcard__bar"></div>
				<div class="postcard__preview-txt"><b>CultSoft Bank</b> is the biggest commercial bank in India. It is a Private sector bank and has its headquarters in Changa, Gujarat. It has a total of 16 regional hubs and 57 zonal offices located at almost every city throughout India.</div>
